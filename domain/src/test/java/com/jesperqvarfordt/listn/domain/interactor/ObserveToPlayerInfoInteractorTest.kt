...
class ObserveToPlayerInfoInteractorTest {
    private lateinit var useCase: ObserveToPlayerInfoInteractor
    ...
    fun setUp() {
        ...
        useCase = ObserveToPlayerInfoInteractor(musicPlayer, Schedulers.trampoline(), Schedulers.trampoline())
    }

...
class ObserveToCombinedInfoInteractorTest {

    private lateinit var useCase: ObserveToCombinedInfoInteractor
    ...
    fun setUp() {
        ...
        useCase = ObserveToCombinedInfoInteractor(musicPlayer, Schedulers.trampoline(), Schedulers.trampoline())
    }

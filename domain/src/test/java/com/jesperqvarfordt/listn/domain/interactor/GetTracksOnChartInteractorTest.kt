...
class GetTracksOnChartInteractorTest {

    private lateinit var useCase: GetTracksOnChartInteractor
    ...
    fun setUp() {
        ...
        useCase = GetTracksOnChartInteractor(repository, Schedulers.trampoline(), Schedulers.trampoline())
    }

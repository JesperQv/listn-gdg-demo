...
class SetPlaylistAndPlayInteractorTest {

    private lateinit var useCase: SetPlaylistAndPlayInteractor
    ...
    fun setUp() {
        ...
        useCase = SetPlaylistAndPlayInteractor(musicPlayer, Schedulers.trampoline(), Schedulers.trampoline())
    }

...
class SkipBackwardsInteractorTest {

    private lateinit var useCase: SkipBackwardsInteractor
    ...
    fun setUp() {
        ...
        useCase = SkipBackwardsInteractor(musicPlayer, Schedulers.trampoline(), Schedulers.trampoline())
    }

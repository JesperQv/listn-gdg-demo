...
class SkipForwardInteractorTest {

    private lateinit var useCase: SkipForwardInteractor
    ...
    fun setUp() {
        ...
        useCase = SkipForwardInteractor(musicPlayer, Schedulers.trampoline(), Schedulers.trampoline())
    }

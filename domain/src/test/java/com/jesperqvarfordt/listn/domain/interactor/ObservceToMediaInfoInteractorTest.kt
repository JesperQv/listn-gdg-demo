...
class ObservceToMediaInfoInteractorTest {

    private lateinit var useCase: ObservceToMediaInfoInteractor
    ...
    fun setUp() {
        ...
        useCase = ObservceToMediaInfoInteractor(musicPlayer, Schedulers.trampoline(), Schedulers.trampoline())
    }

...
class GetChartsInteractorTest {

    private lateinit var useCase: GetChartsInteractor
    ...
    fun setUp() {
        ...
        useCase = GetChartsInteractor(repository, Schedulers.trampoline(), Schedulers.trampoline())
    }

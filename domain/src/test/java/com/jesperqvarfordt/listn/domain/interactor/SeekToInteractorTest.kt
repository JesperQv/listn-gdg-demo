...
class SeekToInteractorTest {

    private lateinit var useCase: SeekToInteractor
    ...
    fun setUp() {
        ...
        useCase = SeekToInteractor(musicPlayer, Schedulers.trampoline(), Schedulers.trampoline())
    }
